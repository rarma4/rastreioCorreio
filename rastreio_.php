...
$url = "https://www.linkcorreios.com.br/?id=$parametros";
	...
	if($parametros == ""){
		...
		if ($email == ""){
			...
			if(!filter_var($email,FILTER_VALIDATE_EMAIL)){
				...
				echo "<script> alert('Por favor, digite seu e-mail corretamente!'); window.history.back(-1);</script>";
			}else{
				...
				<a href='http://www.casalsign.com.br' target='_blank'>casalsign.com.br</a><br><br><br><br>
				Designed by <a href='http://www.rafart.com.br' target='_blank'>Raf'Art</a>
				";
